...
namespace ContainerWireup
{
    ...
    public class ButtonPressEvent: IEvent
    {
        public int NumberOfClicks;
    }

    public class Button : ISend<ButtonPressEvent>
    {
        public event EventHandler<ButtonPressEvent> Sender;

        public void Fire(int clicks)
        {
            Sender?.Invoke(this, new ButtonPressEvent { NumberOfClicks = clicks });
        }
    }

    public class Logging : IHandle<ButtonPressEvent>
    {
        public void Handle(object sender, ButtonPressEvent args)
        {
            Console.WriteLine(
